...
try {
    ...
    //Recipients
    $sql="SELECT * FROM `tbl_students_master` WHERE member_id='".$sess_data_var['sess_user_id']."'";
    $i=0;
    ...
    $mail->Body    = 'Your Vote has been registered! Thankyou for voting.';
    $mail->AltBody = 'Your Vote has been registered! Thankyou for voting.';

    $mail->send();
    $call_config->msg("Success!!","Mail Sent!!","success","student/recent_elections/","");
} catch (Exception $e) {
